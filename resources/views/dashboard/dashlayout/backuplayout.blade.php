                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="dashboard/pages/ui-features/buttons.html">
                                            Buttons
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="dashboard/pages/ui-features/typography.html">
                                            Typography
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="icons">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="dashboard/pages/icons/font-awesome.html">
                                            Font Awesome
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="auth">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="dashboard/pages/samples/blank-page.html">
                                            Blank Page
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="dashboard/pages/samples/login.html">
                                            Login
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="dashboard/pages/samples/register.html">
                                            Register
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="dashboard/pages/samples/error-404.html">
                                            404
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="dashboard/pages/samples/error-500.html">
                                            500
                                        </a>
                                    </li>
                                </ul>
